...
from map_data.InD_map_data.aseag_04_data import road_lane_paths_data   
...
class AseagProcessor:
    ...
    def update_tracks_with_lane_info(self, csv_path):
        ...
        #self.road_lane_paths = self.load_road_lane_paths_pickle(file_path)
        '''
        file_path = 'map_data/InD_map_data/aseag_04.pkl'
        try:
            with open(file_path, 'rb') as file:
                data = pickle.load(file)
            
            with open('map_data/InD_map_data/aseag_04_data.py', 'w', encoding='utf-8') as py_file:
