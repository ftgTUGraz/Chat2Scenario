...
from map_data.InD_map_data.frankenburg_02_data import road_lane_paths_data   
...
class FrankenbergProcessor:
    ...
    def update_tracks_with_lane_info(self, csv_path):
        ...
        '''
        file_path = 'map_data/InD_map_data/frankenburg_02.pkl'
        ...
        try:
            ...
            with open('map_data/InD_map_data/frankenburg_02_data.py', 'w', encoding='utf-8') as py_file:
