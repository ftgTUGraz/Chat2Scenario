...
def main():
    ...
    #write_lane_polygons_to_file(lane_polygons, 'RounD_data.py', 'lanes_polygons1')

    importlib.reload(RounD_data)
    '''
    # Plot polygons
    plot_multiple_polygons({i: [polygon] for i, polygon in enumerate(RounD_data.lanes_polygons1)})
