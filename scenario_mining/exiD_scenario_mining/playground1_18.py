...
class TrackDataProcessor:
    ...
    def determine_turn_type_and_lane(self, point, onramp_polygon, offramp_polygon, lanes_polygons):
        """
        Determine the turn type and lane ID of a trajectory point.

        Parameters:
        point (Point): Trajectory point
        onramp_polygon (Polygon): OnRamp polygon
        offramp_polygon (Polygon): OffRamp polygon
